...
def main():
    ...
    S = Scheduler()
    # 文本图像混合任务
    list1 = [(text, "路人甲", "今天天气如何"),  (voice, "路人乙", "音频Z.mp3"), (image, "路人丙", "图片A.jpg"), (image, "路人乙", "图片B.jpg"),  (voice, "路人丙", "音频Y.mp3"), (text, "路人乙", "附近有什么好吃的"),  (image, "路人甲", "图片C.jpg"), (text, "路人丙", "帮我写一段有关环境保护的作文"), (voice, "路人甲", "音频X.mp3")]
    # 串行任务
    ...
    list2 = [f"串行总耗时{tc:.2f}秒，并行总耗时{tb:.2f}秒", f"并行节省了{(tc-tb):.2f}秒，加速比为{tc/tb:.2f}", f"当前系统时间为：{datetime.strftime(datetime.now(), "%Y-%m-%d %H:%M:%S")}"]
